...
import { showLaunches } from '../launches-list.js'

async function Home() {
  const result = await getData('launches/next');
  ...
  const launchesHtml = showLaunches(launches)
  main.insertAdjacentHTML('beforeend', launchesHtml)
